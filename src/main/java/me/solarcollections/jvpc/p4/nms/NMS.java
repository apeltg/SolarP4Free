package me.solarcollections.jvpc.p4.nms;

import me.solarcollections.jvpc.p4.nms.entity.*;
import me.solarcollections.jvpc.p4.nms.interfaces.BalloonEntity;
import me.solarcollections.jvpc.reflection.Accessors;
import me.solarcollections.jvpc.reflection.acessors.FieldAccessor;
import me.solarcollections.jvpc.utils.Utils;
...
public class NMS {
  ...
  static {
    ...
    CLASS_TO_NAME.get(null).put(EntityCart.class, "sCart");
    CLASS_TO_NAME.get(null).put(EntityFirework.class, "sFirework");
    CLASS_TO_NAME.get(null).put(BalloonEntityBat.class, "sBat");
    CLASS_TO_NAME.get(null).put(BalloonEntityLeash.class, "sLeash");
    CLASS_TO_NAME.get(null).put(BalloonEntityGiant.class, "sGiant");
    CLASS_TO_NAME.get(null).put(MountableEnderDragon.class, "sEnderDragon");
  ...
  public static Entity createAttachedCart(String owner, Location location) {
    ...
    me.solarcollections.jvpc.nms.NMS.look(cart.getBukkitEntity(), location.getYaw(), location.getPitch());
