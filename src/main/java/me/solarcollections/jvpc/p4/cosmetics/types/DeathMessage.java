...
public class DeathMessage extends Cosmetic {
  ...
  public static final SLogger LOGGER = ((SLogger) Main.getInstance().getLogger()).getModule("DEATH_MESSAGE");
  ...
  public static void setupDeathMessages() {
    SConfig config = Main.getInstance().getConfig("cosmetics", "deathmessages");
