...
public class DeathCry extends Cosmetic {
  ...
  public static final SLogger LOGGER = ((SLogger) Main.getInstance().getLogger()).getModule("DEATH_CRY");
  ...
  public static void setupDeathCries() {
    SConfig config = Main.getInstance().getConfig("cosmetics", "deathcries");
