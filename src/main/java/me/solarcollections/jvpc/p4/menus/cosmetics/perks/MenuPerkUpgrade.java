...
import me.solarcollections.jvpc.p4.menus.cosmetics.perks.level.MenuBuyCashPerkLevel;
import me.solarcollections.jvpc.p4.menus.cosmetics.perks.level.MenuBuyPerkLevel;
...
public class MenuPerkUpgrade<T extends Perk> extends PlayerMenu {
  ...
  public MenuPerkUpgrade(Profile profile, String name, T cosmetic, Class<T> cosmeticClass) {
    ...
    long currentLevel = profile.getAbstractContainer("sCoreP4", "cosmetics", CosmeticsContainer.class).getLevel(cosmetic);
    int slot = 0;
          ...
          if (item != null && item.getType() != Material.AIR) {
            if (evt.getSlot() == 40) {
              ...
              if (perkLevel != null) {
                ...
                if (profile.getCoins("sCoreP4") < perkLevel.getCoins() && (CashManager.CASH && profile.getStats("sCoreProfile", "cash") < perkLevel.getCash())) {
