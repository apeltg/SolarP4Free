...
public class MenuBuyPerkLevel<T extends Perk> extends PlayerMenu {
  ...
  public MenuBuyPerkLevel(Profile profile, String name, T cosmetic, PerkLevel perkLevel, long level, Class<T> cosmeticClass) {
    ...
    this.setItem(11, BukkitUtils.deserializeItemStack(
        "WOLL:13 : 1 : nome>&aConfirmar : desc>&7Comprar \"" + cosmetic.getName() + levelName + "\"\n&7por &6" + StringUtils.formatNumber(perkLevel.getCoins()) + " Coins&7."));
    
    this.setItem(15, BukkitUtils.deserializeItemStack("WOLL:14 : 1 : nome>&cCancelar : desc>&7Voltar para a Habilidade " + cosmetic.getName() + "."));
        ...
        if (evt.getClickedInventory() != null && evt.getClickedInventory().equals(this.getInventory())) {
          ...
          if (item != null && item.getType() != Material.AIR) {
            if (evt.getSlot() == 11) {
              ...
              profile.getAbstractContainer("sCoreP4", "cosmetics", CosmeticsContainer.class).setLevel(this.cosmetic, level);
