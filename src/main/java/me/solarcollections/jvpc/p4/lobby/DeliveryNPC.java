package me.solarcollections.jvpc.p4.lobby;

import me.solarcollections.jvpc.libraries.holograms.HologramLibrary;
import me.solarcollections.jvpc.libraries.holograms.api.Hologram;
...
public class DeliveryNPC {
  ...
  private static final SConfig CONFIG = Main.getInstance().getConfig("npcs");
