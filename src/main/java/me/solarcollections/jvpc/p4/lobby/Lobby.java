...
import me.solarcollections.jvpc.servers.ServerItem;
import me.solarcollections.jvpc.servers.ServerPing;
...
public class Lobby {
  ...
  public static final SConfig CONFIG = Main.getInstance().getConfig("lobbies");
